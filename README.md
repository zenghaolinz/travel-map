...
* **🤖 AI 语义理解 (Local AI)**
* 集成 **Ollama (Qwen 模型)**，精准理解“北京坐高铁去上海，然后飞往东京”等复杂自然语言指令。
...
* 安装 **[Tesseract-OCR](https://www.google.com/search?q=https://github.com/UB-Mannheim/tesseract/wiki)**。
